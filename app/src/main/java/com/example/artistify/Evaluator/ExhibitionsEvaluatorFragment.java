 ...
 * Use the {@link ExhibitionsEvaluatorFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ExhibitionsEvaluatorFragment extends Fragment {
    ...
    public ExhibitionsEvaluatorFragment() {
     ...
     * @return A new instance of fragment ExhibitionsEvaluatorFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static ExhibitionsEvaluatorFragment newInstance(String param1, String param2) {
        ExhibitionsEvaluatorFragment fragment = new ExhibitionsEvaluatorFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_exhibitions_evaluator, container, false);

        mDatabase= FirebaseDatabase.getInstance().getReference().child("Contest_results");
        mDatabase.keepSynced(true);

        ContestsListExhibition=(RecyclerView)view.findViewById(R.id.myEvaluatorExhibitionsRecycleView);
